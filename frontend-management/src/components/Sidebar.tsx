    ...
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-[#1E1E1E] text-white overflow-y-auto">
      ...
      <div className="p-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[var(--color-accent)] rounded-lg flex items-center justify-center overflow-hidden">
            <svg viewBox="0 0 40 40" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="40" height="40" rx="8" fill="#C9A664"/>
              <path d="M12 28V12h4v12h8v4H12z" fill="white"/>
              <path d="M24 12h4v4h-4v-4z" fill="white"/>
              <path d="M24 20h4v8h-4v-8z" fill="white"/>
            </svg>
          </div>
