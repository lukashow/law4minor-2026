    ...
    <section ref={sectionRef} className="section bg-accent">
      <div className="container">
        <div className="text-center mb-12">
          <span className="text-primary-light text-sm font-medium uppercase tracking-wider">Our Programs & Resources</span>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-xl bg-primary/10 group-hover:bg-primary flex items-center justify-center text-primary group-hover:text-accent mb-6 transition-all">
                {service.icon}
              </div>
              <h3 className="font-serif text-xl font-semibold text-white group-hover:text-primary-light mb-3 transition-colors">
                {service.title}
              </h3>
