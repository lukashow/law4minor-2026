  ...
  return (
    <div className="pt-24 pb-16 bg-[var(--color-paper)]">
      <div className="container max-w-3xl">
        <h1 className="font-serif text-4xl md:text-5xl font-bold text-[var(--color-accent)] mb-8">Privacy Policy</h1>

        <div className="prose prose-lg text-gray-600">
          <p className="text-lg mb-6">Last updated: January 2026</p>

          <h2 className="font-serif text-2xl font-bold text-[var(--color-primary)] mt-8 mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--color-primary)] mt-8 mb-4">2. How We Use Your Information</h2>
          <p>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--color-primary)] mt-8 mb-4">3. Information Sharing</h2>
          <p>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--color-primary)] mt-8 mb-4">4. Data Security</h2>
          <p>
            We implement appropriate security measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction.
          </p>

          <h2 className="font-serif text-2xl font-bold text-[var(--color-primary)] mt-8 mb-4">5. Contact Us</h2>
          <p>
