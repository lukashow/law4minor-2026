  ...
  return (
    <div className="pt-24 pb-16 bg-paper">
      <div className="container max-w-3xl">
        <h1 className="font-serif text-4xl md:text-5xl font-bold text-accent mb-8">Terms of Service</h1>
        ...
        <div className="prose prose-lg text-gray-600">
          ...
          <h2 className="font-serif text-2xl font-bold text-primary mt-8 mb-4">2. Educational Purpose</h2>
          <p>
          ...
          <h2 className="font-serif text-2xl font-bold text-primary mt-8 mb-4">3. Intellectual Property</h2>
          <p>
          ...
          <h2 className="font-serif text-2xl font-bold text-primary mt-8 mb-4">4. Limitation of Liability</h2>
          <p>
            Law4Minor shall not be liable for any damages arising from the use or inability to use this website or its content.
          </p>

          <h2 className="font-serif text-2xl font-bold text-primary mt-8 mb-4">5. Contact</h2>
          <p>
